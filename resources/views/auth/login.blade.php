    ...
    <div class="w-full h-screen bg-loginpattern bg-no-repeat relative bg-[center_top_-25rem]">
        ...
        <div class="w-full absolute top-32 bg-white bottom-0 rounded-t-3xl shadow-lg overflow-auto">
            <div aria-label="pembungkus putih" class="px-8">
                ...
                @error('code')
                <div
                    class="flex items-center p-4 mb-4 text-sm text-red-800 border border-red-300 rounded-lg bg-red-50 dark:bg-red-200 dark:text-red-700 dark:border-red-800"
                    role="alert">
                ...
                <div class="mt-6 flex flex-col">
                    ...
                    <input id="kodeAgen" type="text" placeholder="Masukan Kode Agenmu"
                           class="@error('email') is-invalid @enderror mt-2 rounded-md bg-inputcoolfresh border-none px-5 py-5 focus:outline-blue-400 placeholder:text-slate-300 placeholder:text-sm placeholder:font-light"
                           name="code" value="{{ old('email') }}" required autocomplete="email" autofocus>
                </div>
                ...
                <div class="mt-3 w-full strength-bar h-2 bg-[#808080] overflow-hidden">
                    <div id="file" class="h-full w-full overflow-hidden bar transition-all" x-bind:class="strength"
                         x-ref="strengthBar"></div>
                </div>
                -->
                <button type="submit"
                        class="w-full rounded-lg block py-5 mt-10 text-center bg-btncoolfresh text-white font-bold hover:opacity-80 hover:cursor-pointer active:bg-coolfreshprimary">
                    Sign
                    In
                </button>
                <!--
